...
export const Icons = {
  ...
  aurora: SunMedium,
  synthwave: Music,
  // Add PascalCase aliases for compatibility with JSON config
  GitHub: undefined as any, // will be set below
  Gmail: undefined as any,
  Linkedin: undefined as any,
};

// PascalCase aliases for JSON config compatibility
Icons.GitHub = Icons.gitHub;
Icons.Gmail = Icons.gmail;
