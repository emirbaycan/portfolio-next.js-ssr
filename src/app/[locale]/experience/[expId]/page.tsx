...
import namanImg from "@/public/emir.jpg";

export default function Experience({ params }: any) {
  // @ts-ignore
  ...
  return (
    <article className="container relative max-w-3xl py-6 lg:py-10">
      ...
      <div>
        <time
          dateTime={typeof exp.startDate === "string" ? exp.startDate : exp.startDate.toISOString()}
          className="block text-sm text-muted-foreground"
        >
          {formatDateFromObj(
            typeof exp.startDate === "string" ? new Date(exp.startDate) : exp.startDate
          )}
        </time>
        <h1 className="flex items-center justify-between mt-2 font-heading text-4xl leading-tight lg:text-5xl">
          ...
          <div className="flex items-center">
            {exp.githubLink && (
              <CustomTooltip text={t("githubTooltip")}>
            ...
            {exp.websiteLink && (
              <CustomTooltip text={t("websiteTooltip")}>
        ...
        <div className="mt-4 flex space-x-4">
          ...
          >
            ...
            <div className="flex-1 text-left leading-tight">
              <p className="font-medium">{"Emir Baycan"}</p>
